...
def summarize_text(text, num_sentences=3):
  # remove special chars, to lowercase
...
def main():
  ...
  <h1 style="color:blue">Powered by Streamlit</h1>
  </div>
  """
  ...
  if choice == "Text Analysis":
    ...
    st.write("")
    raw_text = st.text_area("Write something", "Hello everybody! How are you doing? Let's write some text just to try this very simple summarization function. Let's check how it is doing...traveling to a new state such as Arizona", height=300)
  ...
  if choice == "Translation":
    ...
    if len(raw_text) < 3:
      ...
      if st.button("Translate"):
        ...
        translator_text = translator.translate(raw_text)
        st.write(translator_text)
